...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	//주일저녁예배
    	fnWorshipSearch("nightWorshipTable","PLKjnkDLEDs8l0L_psNrf57swDvIuQBn1Y",50);
		...
		window.open(link, "_blank");  
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">주일저녁말씀</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Sunday evening sermon</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
