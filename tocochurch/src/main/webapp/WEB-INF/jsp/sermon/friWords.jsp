...
<script type="text/javascript">
    ...
    $(document).ready(function () {
    	...
    	// 금요기도회
    	fnWorshipSearch("fridWorshipTable","PLKjnkDLEDs8nZ4BanFcUgDQHpNaFPQ4zK",50);
		...
		window.open(link, "_blank");  
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">금요기도회</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Friday Prayer Meeting Sermon</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
